...
namespace VotersInfomationSystem
{
    public partial class AddVoters : UserControl
    {
        ...
        string connString = "server = 192.168.0.10; user id = root; database = teamjocas";
        ...
        private void txtvn_TextChanged(object sender, EventArgs e)
        {
            ...
            MySqlConnection sqlcon2 = new MySqlConnection("server = 192.168.0.10; user id = root; database = teamjocas");
            ...
            if (temp > 0)
            {
                ...
                string source = ("server = 192.168.0.10; user id = root; database = teamjocas");
        ...
        private void button_WOC1_Click(object sender, EventArgs e)
        {
            ...
            if (result.Equals(DialogResult.OK))
            {
                ...
                try
                {
                    ...
                    {
                        MySqlConnection sqlcon = new MySqlConnection("server = 192.168.0.10; user id = root; database = teamjocas");
                        sqlcon.Open();
